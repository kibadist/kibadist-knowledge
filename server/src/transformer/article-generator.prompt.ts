...
- "equation": when a source block is display MATH (LaTeX like $$...$$, \\[...\\], \\begin{equation}, or clearly mathematical notation), it stays an equation — VERBATIM. { "type": "equation", "latex": "<the source's own LaTeX, outer delimiters stripped>", "equationStatus": "verbatim" }. Use "normalized" ONLY when you stripped delimiters/whitespace; never alter, derive, or invent math, and never flatten an equation into prose.
